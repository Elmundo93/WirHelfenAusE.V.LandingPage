...
export default function ZigZag() {  return (
  ...
  <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-left">
    <div className="md:pl-4 lg:pl-12 xl:pl-16">
      ...
      Bei Fragen jeder Art stehen wir als Verein ihnen zur Seite.<br></br><br></br> Des weiteren finden Sie alle nötigen Links zur Minijob-Zentrale bei uns auf der Homepage. </p>
                </div>
              </div>
            </AnimatedElement>
