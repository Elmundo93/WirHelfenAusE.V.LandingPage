      ...
      <div className="border-t mt-20 max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="relative inline-block w-full max-w-md mx-auto">
          ...
          <section  className="items-strech max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            {/* 4th item */}
            <AnimatedElement className="sm:mt-10 h-full bg-white/4 backdrop-blur-xl rounded-xl shadow-lg p-4 relative flex flex-col items-center md:mt-10" data-aos="fade-up" data-aos-delay="300" data-aos-anchor="[data-aos-id-blocks]">
            ...
            {/* 5th item */}
            <AnimatedElement className="sm:mt-10 md:mt-10 h-full bg-white/4 backdrop-blur-xl rounded-xl shadow-lg p-4 relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-blocks]">
            ...
            {/* 6th item */}
            <AnimatedElement className="sm:mt-10 md:mt-10 h-full bg-white/4 backdrop-blur-xl rounded-xl shadow-lg p-4 relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="500" data-aos-anchor="[data-aos-id-blocks]">
