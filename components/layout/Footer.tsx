...
export default function Footer() {
  ...
  return (
    <footer className="bg-background border-t border-border mt-16">
      <div className="container py-12 px-4 md:px-8 grid gap-12 md:grid-cols-3 text-sm text-foreground">
        {/* Verein */}
        <div>
          <h6 className="text-foreground font-semibold mb-4">Wir helfen aus e.V.</h6>
        ...
        {/* Nützliche Links */}
        <div>
          <h6 className="text-foreground font-semibold mb-4">Nützliche Links</h6>
          <ul className="space-y-2">
        ...
        {/* Datenschutz */}
        <div>
          <h6 className="text-foreground font-semibold mb-4">Richtlinien & Datenschutz</h6>
          <ul className="space-y-2">
      ...
      <div className="container pb-8 flex flex-col md:flex-row justify-between items-center gap-4 px-4 md:px-8">
        <div className="text-muted-foreground text-sm">&copy; {new Date().getFullYear()} Wir helfen aus e.V.</div>
        <div className="flex gap-5 text-muted-foreground">
          <Link href="/" aria-label="Twitter"><SiX className="w-5 h-5 hover:text-blue-500" /></Link>
          <Link href="/" aria-label="GitHub"><SiGithub className="w-5 h-5 hover:text-gray-800 dark:hover:text-gray-200" /></Link>
