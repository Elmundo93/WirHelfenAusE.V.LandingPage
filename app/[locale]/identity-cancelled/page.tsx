...
export default function IdentityCancelledPage() {
  ...
  const handleLoadingComplete = () => {
    const deepLinkUrl = 'aushilfapp://onboarding/verify-identity-cancelled'
    ...
    setTimeout(() => {
      ...
      if (window.location.pathname.includes('identity-cancelled')) {
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-amber-50/30 to-amber-100/20">
        <div className="text-center p-8 max-w-md">
          <h1 className="text-2xl font-bold text-red-600 mb-4">
            ❌ Identitätsverifikation abgebrochen
          </h1>
          <p className="text-gray-600 mb-6">
            Die Identitätsverifikation wurde abgebrochen. 
